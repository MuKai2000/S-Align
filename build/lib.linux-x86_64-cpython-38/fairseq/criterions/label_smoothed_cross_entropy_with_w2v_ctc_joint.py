...
@register_criterion("label_smoothed_cross_entropy_with_w2v_ctc_joint")
class LabelSmoothedCrossEntropywithW2vCtcJoint(
    ...
    def __init__(self, task, sentence_avg, label_smoothing, post_process="letter", ctc_weight=0.0, 
        ...
        self.train_st_without_ctc =  getattr(task, "train_st_without_ctc", False) #train_st_without_ctc
