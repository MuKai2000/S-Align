...
@register_task("CMCL_train")
class CMCLTrainTask(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        src_pre_tokenizer = self.build_tokenizer(self.args)
    ...
    def build_model(self, args):
        ...
        return super(CMCLTrainTask, self).build_model(args)
    ...
    def build_generator(
        ...
        lang_token_ids = {
            ...
            if SpeechToTextJointDataset.is_lang_tag(s)
        }
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, **kwargs):
        return SpeechToTextJointDataset( "interactive", False, self.data_cfg, src_tokens, src_lengths
        )
