        ...
        # ************/ Add AT per-task /************ #
            ...
            if sample['st'] is not None:
                ...
                if self.at_level == "sentence":
                    ...
                    # print(" > 5. ", task_input.shape, task_input.dtype)
                    unzero_mask = torch.any(task_input != 0, dim=1)
                    task_input[unzero_mask]     # [num_unzero, dim=512] 
                    # print(" > 6. ", task_input.shape, task_input.dtype)
            ...
            if self.at_level == "sentence":
                ...
                weight = 1.0 / ((0 if sample['st'] is None else (st_encoder_out["encoder_padding_mask"][0].shape[0] / (1 if self.at_level == "token" else self.at_win['stride'])))
