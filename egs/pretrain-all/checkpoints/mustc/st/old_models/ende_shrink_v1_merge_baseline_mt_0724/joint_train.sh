...
task=joint_triple_pretraining                                                                 # //need_check//
vocab_type=unigram
asr_vocab_size=5000
vocab_size=10000
share_dict=1
...
exp_name=ende_shrink_v1_merge_baseline_mt_0724
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    cp ${root_dir}/fairseq/tasks/joint_triple_pretraining.py ${model_dir}
    cp ${root_dir}/fairseq/criterions/label_smoothed_cross_entropy_with_w2v_ctc_shrink_joint_AT.py ${model_dir}
