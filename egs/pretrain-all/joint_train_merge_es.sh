...
#exp_name=ende_shrink_v2_merge_large_0821_doubleCL_AT_sentence_mixup0307_alpha1.5_mt0.5
#exp_name=ende_shrink_v2_merge_large_0822_noCL_AT_sentence_mixup0307_scale2.5_alpha0_mt0.5
#exp_name=ende_shrink_v2_merge_large_0823_topCL_AT_sentence_mixup0307_scale2.5_alpha1.5_mt0.5

#exp_name=ende_shrink_v2_merge_mustc_0824_soft_noCL_AT_sentence_mixup0307_scale1.5_alpha0_mt0.5

#exp_name=ende_shrink_v2_merge_wmt_0826_both_lowCL_AT_sentence_mixup0109_scale2.5_alpha1.5_mt0.5
#exp_name=ende_shrink_v2_merge_wmt_0826_both_topCL_AT_sentence_mixup0109_scale2.5_alpha1.5_mt0.5_nograd_changeid
#exp_name=ende_shrink_v2_merge_wmt_0826_soft_noCL_AT_sentence_mixup0109_scale2.5_alpha0_mt0.5_nograd
#exp_name=ende_shrink_v2_merge_mustc_0827_both_topCL_AT_sentence_mixup0109_scale5_alpha1.5_mt0.5_nograd
###exp_name=ende_shrink_v2_merge_wmt_0828_both_doubleCL_AT_sentence_mixup0307_scale2.5_alpha1.5_mt0.5_nograd


#exp_name=enes_shrink_v2_merge_wmt_0830_hard_baseline_lowCL_alpha1.5_mt0.5_lowgrad_highnograd
#exp_name=enes_shrink_v2_merge_wmt_0831_soft_noCL_AT_sentence_mixup0307_scale2.5_alpha0_mt0.5_lowgrad_highnograd
#exp_name=enes_shrink_v2_merge_wmt_0831_soft_noCL_AT_sentence_mixup0307_scale2.5_alpha0_mt0.5_lowgrad_highnograd_turnid
# exp_name=enes_shrink_v2_merge_wmt_0901_soft_noCL_AT_sentence_mixup07_scale3.5_alpha0_mt0.5_lowgrad_highnograd
#exp_name=enes_shrink_v2_merge_wmt_0830_both_topCL_AT_sentence_mixup0307_scale3.5_alpha1.0_mt0.5_lowgrad_highnograd


exp_name=enes_v4_merge_wmt_0905_shrink_soft_noCL_AT_sentence_mixup_changeid_scale3.5_alpha0_mt0.5
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    cp ${root_dir}/fairseq/models/speech_to_text/s2t_joint.py ${model_dir}
    cp ${root_dir}/fairseq/tasks/joint_triple_pretraining_merge.py ${model_dir}
    cp ${root_dir}/fairseq/criterions/label_smoothed_cross_entropy_with_w2v_ctc_shrink_joint_AT_merge.py ${model_dir}
