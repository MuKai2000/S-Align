...
@dataclass
class CTCContrastiveLossConfig(CtcCriterionConfig):
...
@register_criterion("ctc_contrastive_loss", dataclass=CTCContrastiveLossConfig)
class CTCContrastiveLoss(CtcCriterion):
    def __init__(self, cfg:CTCContrastiveLossConfig, task:FairseqTask): #, sentence_avg, contrastive_lambda=0.0, contrastive_temperature=1.0, get_similarity=False):
