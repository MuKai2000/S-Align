...
@dataclass
class CTCMTContrastiveKDLossConfig(CtcCriterionConfig):
...
@register_criterion("ctc_mt_contrastive_kd_loss", dataclass=CTCMTContrastiveKDLossConfig)
class CTCMTContrastiveKDLoss(CtcCriterion):
    def __init__(self, cfg:CTCMTContrastiveKDLossConfig, task:FairseqTask): #, sentence_avg, contrastive_lambda=0.0, contrastive_temperature=1.0, get_similarity=False):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        mbart_out = model.mt_model_encoder(kd_sample["net_input"]["src_tokens"], kd_sample["net_input"]["src_lengths"])
