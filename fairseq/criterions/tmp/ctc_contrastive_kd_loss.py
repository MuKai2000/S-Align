...
@dataclass
class CTCContrastiveKDLossConfig(CtcCriterionConfig):
...
@register_criterion("ctc_contrastive_kd_loss", dataclass=CTCContrastiveKDLossConfig)
class CTCContrastiveKDLoss(CtcCriterion):
    def __init__(self, cfg:CTCContrastiveKDLossConfig, task:FairseqTask): #, sentence_avg, contrastive_lambda=0.0, contrastive_temperature=1.0, get_similarity=False):
