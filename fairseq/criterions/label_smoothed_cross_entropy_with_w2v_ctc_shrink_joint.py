...
@register_criterion("label_smoothed_cross_entropy_with_w2v_ctc_shrink_joint")
class LabelSmoothedCrossEntropywithW2vCtcShrinkJoint(
    ...
    def __init__(self, task, sentence_avg, label_smoothing, post_process="letter", ctc_weight=0.0, 
                 ...
                 train_st_without_ctc=False, max_position_ctc=0, use_token_contrastive=False, use_two_contrastive=False, add_proj_norm=False, use_double_ctc=False):
        ...
        if per_task == "st":
            ...
            if model.training:
                if self.ctc_weight > 0:
                    ...
                    w2v_ctc_loss = self.compute_ctc_loss(model, sample, encoder_out, True, self.train_st_without_ctc)
