...
@register_task("joint_triple_pretraining_bkp_0723")
class JointTriplePretrainingTaskBKP(SpeechToTextTask):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, tgt_dict, src_dict=None, cluster_convert=None):
        ...
        self.merge_mt_st = args.merge_mt_st if self.keep_mt_task else False
        # ************/ Add L2 norm /************ #
    ...
    def _per_task_train_loss(
        ...
        if per_task == "st" and update_num < 3000:        # asronly 不做ctc_shrink去掉                  //need_check//
            ignore_grad=True
        # if per_task == "at" and update_num < 3000:            //need_check//
        #     ignore_grad=True
    ...
    def train_step(
        ...
        # ************/ Add AT per-task /************ #
        if ('st' in sample.keys() or 'mt' in sample.keys()) and self.at_training:
        ...
        if self.merge_mt_st and 'mt' in sample.keys():
            del sample["mt"]        # merge mt task with st
