...
@dataclass
class AdapterPretrainingConfig(FairseqDataclass):
...
@register_task("adapter_pretraining", dataclass=AdapterPretrainingConfig)
class AdapterPretrainingTask(FairseqTask):
    """"""

    cfg: AdapterPretrainingConfig
    ...
    @classmethod
    def setup_task(cls, cfg: AdapterPretrainingConfig, **kwargs):
        """Setup the task (e.g., load dictionaries).

        Args:
            cfg (AdapterPretrainingConfig): configuration of this task
        """
