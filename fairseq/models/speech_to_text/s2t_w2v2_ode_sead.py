...
from fairseq.models.speech_to_text.s2t_w2v2_mbart_sead import S2T_W2V2_ConformerEncoder
...
@register_model("s2t_w2v2_ode_sead")
class S2TW2V2ODESEAD(FairseqEncoderDecoderModel):
...
#            args_state = checkpoint_utils.load_checkpoint_to_cpu("/mnt/zhangyuhao/pretrain-model/w2v_large_lv_fsh_swbd_cv.pt", arg_overrides={})
...
@register_model_architecture(model_name="s2t_w2v2_ode_sead",
                             arch_name="s2t_w2v2_ode_sead")
...
@register_model_architecture("s2t_w2v2_ode_sead", "s2t_w2v2_ode_sead_s")
